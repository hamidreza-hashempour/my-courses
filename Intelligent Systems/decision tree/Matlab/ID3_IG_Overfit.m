function [ tree ] = ID3_IG_Overfit( data, label, id, values, depth)
...
Information_Gain = IG(data, label);
...
for i=1:max(size(unique_label))
    ...
    [ tree{i,2} ] = ID3_IG_Overfit(new_data, new_label, new_id, unique_label(i), depth+1);
