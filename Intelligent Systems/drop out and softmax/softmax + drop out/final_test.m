...
%%defining funcs and number if epochs and numbers of datas
    ...
    [weights,Total_Error_Matrix,Error_On_Test,AccuracyFinal] = training(weights, Num_Of_Epoches, Train_Attr, Out_Target_A_O,Mini_Batch_Num,Test_Attr,Test_Label,Learning_Rate,Hidden_Func);
