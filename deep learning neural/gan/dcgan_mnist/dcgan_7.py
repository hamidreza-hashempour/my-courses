...
class DCGAN():
    def __init__(self):
        ...
        self.discriminator.compile(loss='mean_squared_logarithmic_error',
            optimizer=optimizer,
            metrics=['accuracy'])
        ...
        self.combined.compile(loss='mean_squared_logarithmic_error', optimizer=optimizer)
